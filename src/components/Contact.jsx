...
export default function Contact() {
  ...
  const links = [
    {
      icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round"><rect x="2" y="4" width="20" height="16" rx="2" /><polyline points="22,7 12,13 2,7" /></svg>,
          ...
          {links.map((link, i) => (
            <a
              ...
              style={{
                ...
                textDecoration: 'none', cursor: 'pointer', padding: '18px 22px',
              }}
            >
              <div style={{
